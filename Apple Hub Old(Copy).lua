...
function Update:Window(text,logo,keybind)
    ...
    Ping.Text = "Blox Fruit | discord.com/DY49H6Gf3q          [RightControl]"
  ...
  --  UserImage.BackgroundColor3 = Color3.fromRGB(225, 225, 225)
    ...
    function main:AddButton(text, callback)
        ...
        ImageButton.Image = "rbxassetid://14886338519"
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        ImageLabel.Image = "rbxassetid://14886338519"
...
NguyenTien:AddLabel("Support Code: Lynx (Bạn Gái Của Tôi)")
...
M:AddToggle('Dịch Chuyển Frozen Dimension [ CHỈ CẦN CÓ ĐẢO ]', false, function(value)
		...
		while wait() do
			pcall(function()
				if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
					...
					Elite_Hunter_Status:Set("❌: Elite Không Spawn")	
				end
			end)
		end
	end)
...
M:AddToggle("Triệu HồiRip Indra [ CHỈ CẦN CÓ CHÉN THÁNH ]",false,function()
AutoHaki()
wait(0.5) 
local args = {
[1] = "activateColor",
...
HyperCahaya(CFrame.new(-5419.98095703125, 1093.3375244140625, -2666.730712890625))
    ...
    M:AddToggle("Farm Điểm Né Haki",_G.AutoObservation,function(value)
    ...
    M:AddToggle("Farm Điểm Né Haki Hop",_G.AutoObservation_Hop,function(value)
